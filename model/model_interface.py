...
class MInterface(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('ftm_loss', ftm_loss, on_step=True, on_epoch=True, prog_bar=True, logger=True)

        tt_loss = self.tt_loss(features, labels)
        loss += tt_loss * self.tt_weight
        self.log('tt_loss', tt_loss, on_step=True, on_epoch=True, prog_bar=True, logger=True)
